...
import SlayTheSpire2Mod.action.AggressionAction;
...
public class AggressionPower extends AbstractPower {
    ...
    public static final String POWER_ID = ModHelper.FormatID(AggressionPower.class.getSimpleName());
    ...
    public AggressionPower(AbstractCreature owner, int amount) {
        ...
        String path128 = "SlayTheSpire2ModResources/img/powers/AggressionPower84.png";
        String path48 = "SlayTheSpire2ModResources/img/powers/AggressionPower32.png";
    ...
    public void atStartOfTurn() {
        this.addToBot(new AggressionAction());
    }
