...
import SlayTheSpire2Mod.action.ExpectAFightAction;
...
public class ExpectAFight extends CustomCard {
    ...
    public static final String ID = ModHelper.FormatID(ExpectAFight.class.getSimpleName());
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "SlayTheSpire2ModResources/img/cards/ExpectAFight.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ExpectAFightAction(this.magicNumber));
